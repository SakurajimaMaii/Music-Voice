...
package cn.govast.vmusic.ui.view;
...
import cn.govast.vasttools.utils.DensityUtils;
...
public class WaveProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.WaveProgressView_main_text_size, (int) DensityUtils.sp2px(16f));
        ...
        mHintColor = ta.getColor(R.styleable.WaveProgressView_hint_color,
                Color.parseColor(DEFAULT_TEXT_COLOR));
        mHintSize = ta.getDimensionPixelSize(R.styleable.WaveProgressView_hint_size, (int) DensityUtils.sp2px(14f));
    ...
    public void setTextSize(int textSize) {
        this.mTextSize = (int) DensityUtils.sp2px(textSize);
    }
    ...
    public void setHintSize(int hintSize) {
        this.mHintSize = (int) DensityUtils.sp2px(hintSize);
    }
    ...
    public void setTextSpace(int textSpace) {
        this.mTextSpace = (int) DensityUtils.dp2px(textSpace);
    }
